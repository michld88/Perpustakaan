...
file_put_contents('app/Http/Controllers/PeminjamanController.php', $content);
echo 'Berhasil: ' . strlen($content) . ' bytes' . PHP_EOL;
echo 'KUOTA: ' . (strpos($content, 'KUOTA_PEMINJAMAN') ? 'ADA' : 'TIDAK') . PHP_EOL;
echo 'DURASI: ' . (strpos($content, 'DURASI_PEMINJAMAN') ? 'ADA' : 'TIDAK') . PHP_EOL;