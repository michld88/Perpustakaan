...
class AnggotaController extends Controller
{
    ...
    {
        // Refresh dari database untuk pastikan data terbaru
        $anggota = Anggota::with('user')->findOrFail($anggota->id);
...
echo 'findOrFail: ' . substr_count($content, 'findOrFail') . ' kali' . PHP_EOL;
